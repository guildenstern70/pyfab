...
books = (
    ...
    },
    {
        ...
        'title': 'Tom Thumb',
        'title_brief': 'Tom Thumb ',
        'title_RO': u'Degețel',
        'title_IT': 'Pollicino',
        'sku': 'SKU #83232',
        'languages': 'English, Italian, Romanian',
        'issuu_id': '8868387/55010352',
